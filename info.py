...
BOT_TOKEN = environ.get('BOT_TOKEN', "6909254063:AAEXr52EVc4SgJ5pz19IiTa3AN5hBhk1Kyg")
API_HASH = environ.get('API_HASH', '2262ef67ced426b9eea57867b11666a1')
BOT_USERNAME = environ.get('BOT_USERNAME', 'Latest_movies_group_bot')
MEDIATOR_BOT = environ.get('MEDIATOR_BOT', 'Latest_movies_group_bot')
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001517345433')  # public channel 
second_auth_channel = environ.get('SECOND_AUTH_CHANNEL', '-1001517345433')  # Add the second auth channel or Group (should private)
third_auth_channel = environ.get('THIRD_AUTH_CHANNEL', '-1001517345433')  # Add the third auth channel or Group (should private)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001517345433')
...
LOG_CHANNEL_V = int(environ.get('LOG_CHANNEL', '-1001517345433'))
LOG_CHANNEL_RQ = int(environ.get('LOG_CHANNEL', '-1001517345433'))
LOG_CHANNEL_NRM = int(environ.get('LOG_CHANNEL', '-1001517345433'))
PM_MSG_LOG_CHANNEL = int(environ.get('PM_MSG_LOG_CHANNEL', '-1001517345433'))
...
ON_HEROKU = False
# for stream #added
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001517345433")
